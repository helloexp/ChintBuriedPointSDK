...
@implementation ChintSAMKeychainQuery
...
- (BOOL)save:(NSError *__autoreleasing *)error {
    ...
    if (status == errSecSuccess) {//item already exists, update it!
        ...
        CFTypeRef accessibilityType = [ChintSAMKeychain accessibilityType];
...
+ (NSError *)errorWithCode:(OSStatus) code {
    ...
    dispatch_once(&onceToken, ^{
        NSURL *url = [[NSBundle bundleForClass:[ChintSAMKeychainQuery class]] URLForResource:@"SAMKeychain" withExtension:@"bundle"];
